...
var defUpperStr = function (Mytext) {
    text = Mytext || 'default text';
    return text.toUpperCase()
};

console.log(defUpperStr('ff'))
...
function ageClassification(n) {
    var age;
    n < 0 || n > 122 ? age = null : n <= 24 ? age = 'детский возраст' : n <= 44 ? age = 'молодой возраст' : n <= 65 ? age = 'средний возраст' : n <= 75 ? age = 'пожилой возраст' : n <= 90 ? age = 'старческий возраст' : age = 'долгожители';
    return age
};
